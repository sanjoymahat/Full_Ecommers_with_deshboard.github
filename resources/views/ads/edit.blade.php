                ...
                <form action="{{ route('ads.update',$ad->id) }}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="description">Original Price(USD)</label>
                            <input type="text" name="or_price" class="form-control" value="{{$ad->price}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="description">sale_Price(USD)</label>
                            <input type="text" name="sale_price" class="form-control" value="{{$ad->price}}">
                            </div>
                            <div class="form-group">
