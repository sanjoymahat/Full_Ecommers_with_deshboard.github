            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('instructor') }}" style="color: #fff;padding-top:15px;">{{ __('Instructor') }}</a>
                        </li>
                            @if (Route::has('login'))
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                @else
                                        ...
                                        <a class="dropdown-item" href="{{ url('saved-ads') }}" style="color:blue">
                                            <i class="fas fa-camera"  style="color:blue"></i> {{ __('Cart') }}
                                        </a>
